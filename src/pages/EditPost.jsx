...
import { ImagePlus, X, FileText, Hash, Image as ImageIcon, Edit3 } from "lucide-react";
      ...
      <div className="min-h-screen bg-background text-foreground transition-colors duration-300">
        <div className="flex items-center justify-center h-[80vh]">
          <div className="flex flex-col items-center gap-4">
            <div className="size-14 rounded-full border-8 border-border/30 border-t-primary animate-spin"></div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-12">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed">
              Update your thoughts and insights
            </p>
          </div>
            ...
            <section className="space-y-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Update your post title</p>
                </div>
              </div>
            ...
            <section className="space-y-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Update the category</p>
                </div>
              </div>
            ...
            <section className="space-y-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Update your cover image</p>
                </div>
              </div>
            ...
            <section className="space-y-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Update your content</p>
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="relative">
                  <Textarea
                    id="content"
                    placeholder="Update your blog content here... Share your thoughts, insights, and stories."
                    value={content}
